...
Nina Lebedeva has proved \cite{lebedeva} that \textit{every $m$-dimensional geodesic $\CBB(0)$ space with $2^m$ extremal points is a quotient of Euclidean space by a crystallographic action}; see the definition below.
