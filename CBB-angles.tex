...
Give an example of a hinge $\hinge p x y$ in a metric space with undefined angle $\mangle\hinge p x y$.
\end{thm}
...
More precisely: suppose that geodesic $[xy]$ is the union of two sides $[px]$ and $[py]$ of hinges $\hinge pxz$ and $\hinge pyz$.
Show that
...
Assume that a hinge $\hinge q p x$ has defined angle.
