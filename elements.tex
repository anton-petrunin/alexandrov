...
The main part is due to Alexadr Alexandov~\cite{alexandrov-1948};
...
In paticular, the existence of bending of a large spherical dome (sphere with a small disc removed) easily follows from these two theorems; moreover it provides an intuitive description of such bending that can be extended to a closed convex surface.
