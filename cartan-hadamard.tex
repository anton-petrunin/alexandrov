\chapter{CAT: globalization}\label{chapter:globalization}
...
Using it with \ref{lem:patch} and uniqueness of geodesics (\ref{cor:loc-geod-are-min}), we get the following.
