...
Further, \textit{surfaces} of convex polyhedrons will be considered with \index{intrinsic metric}\emph{intrinsic metric}; it is defined as the length of a shortest path on the surface between points.
Shortest paths parametrized by arclength will be called \index{geodesic}\emph{geodesics}; 
...
The \index{curvature}\emph{curvature} of a point $p\in P$ is defined as $2\cdot \pi -\theta$,
...
A point on the sphere with positive curvature will be called an \index{essential vertex}\emph{essential vertex}.
