...
By Exercise~\ref{ex:CAT-limit}, the $\eps$-neighborhood of $p$ is $\CAT(0)$.
\qeds
...
$K_n$ is $\CAT(0)$.
It remains to note that $K_n\to \Gamma$ in the sense of Gromov--Hausdorff, and apply \ref{ex:CAT-limit}.
\qeds
